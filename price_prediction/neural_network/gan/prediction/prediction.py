...
G_model = tf.keras.models.load_model('../../Models/GAN_30to3.h5to1.h5')
...
def get_test_plot(X_test, y_test):
    ...
    print("rescaled_predicted_y ", rescaled_predicted_y.shape[0])
    print("rescaled_predicted_y ", rescaled_real_y.shape[0])

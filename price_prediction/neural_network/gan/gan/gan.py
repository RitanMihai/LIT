...
X_train = np.load( "../data_processing/dataset/X_train.npy", allow_pickle=True)
y_train = np.load( "../data_processing/dataset/y_train.npy", allow_pickle=True)
X_test = np.load(  "../data_processing/dataset/X_test.npy", allow_pickle=True)
y_test = np.load(  "../data_processing/dataset/y_test.npy", allow_pickle=True)
yc_train = np.load("../data_processing/dataset/yc_train.npy", allow_pickle=True)
yc_test = np.load( "../data_processing/dataset/yc_test.npy", allow_pickle=True)
...
class GAN:
    ...
    def train(self, real_x, real_y, yc, opt):
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % 15 == 0:
                tf.keras.models.save_model(generator, 'model/gen_model_3_1_%d.h5' % epoch)
...
X_scaler = load(open('../data_processing/dataset/X_scaler.pkl', 'rb'))
y_scaler = load(open('../data_processing/dataset/y_scaler.pkl', 'rb'))
train_predict_index = np.load("../data_processing/dataset/index_train.npy", allow_pickle=True)
test_predict_index = np.load( "../data_processing/dataset/index_test.npy", allow_pickle=True)

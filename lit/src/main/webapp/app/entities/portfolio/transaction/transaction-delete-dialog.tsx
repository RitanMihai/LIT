...
export const TransactionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="litApp.portfolioTransaction.delete.question">
        <Translate contentKey="litApp.portfolioTransaction.delete.question" interpolate={{ id: transactionEntity.id }}>

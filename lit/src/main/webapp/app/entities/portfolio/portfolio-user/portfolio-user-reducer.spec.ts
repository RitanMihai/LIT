...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORTFOLIOUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PORTFOLIOUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PORTFOLIOUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PORTFOLIOUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PORTFOLIOUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PORTFOLIOUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PORTFOLIOUSER actions', async () => {
      const expectedActions = [
        {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIVIDEND_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DIVIDENDS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DIVIDEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIVIDEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIVIDEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIVIDEND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIVIDEND actions', async () => {
      const expectedActions = [
        {

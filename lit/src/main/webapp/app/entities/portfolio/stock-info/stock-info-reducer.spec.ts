...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKINFO_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STOCKINFOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STOCKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKINFO actions', async () => {
      const expectedActions = [
        {

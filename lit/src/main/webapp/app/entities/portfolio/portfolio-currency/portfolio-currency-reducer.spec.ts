...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './portfolio-currency.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PORTFOLIOCURRENCY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PORTFOLIOCURRENCIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PORTFOLIOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PORTFOLIOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PORTFOLIOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PORTFOLIOCURRENCY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PORTFOLIOCURRENCY actions', async () => {
      const expectedActions = [
        {

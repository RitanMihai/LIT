...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERFOLLOWING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERFOLLOWINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERFOLLOWING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERFOLLOWING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERFOLLOWING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERFOLLOWING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERFOLLOWING actions', async () => {
      const expectedActions = [
        {

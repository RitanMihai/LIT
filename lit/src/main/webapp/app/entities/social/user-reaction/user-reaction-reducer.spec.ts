...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERREACTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_USERREACTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_USERREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERREACTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERREACTION actions', async () => {
      const expectedActions = [
        {

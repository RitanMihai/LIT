...
import { IComment, defaultValue } from 'app/shared/model/social/comment.model';
...
const apiUrl = 'services/social/api/comments';
const apiSearchUrl = 'services/social/api/_search/comments';

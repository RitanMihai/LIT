...
import { IPost, defaultValue } from 'app/shared/model/social/post.model';
...
const apiUrl = 'services/social/api/posts';
const apiSearchUrl = 'services/social/api/_search/posts';

// Actions

export const searchEntities = createAsyncThunk('post/search_entity', async ({ query, page, size, sort }: IQueryParams) => {

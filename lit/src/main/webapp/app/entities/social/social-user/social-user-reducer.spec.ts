...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOCIALUSER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SOCIALUSERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SOCIALUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOCIALUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOCIALUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOCIALUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOCIALUSER actions', async () => {
      const expectedActions = [
        {

...
import { ITag, defaultValue } from 'app/shared/model/social/tag.model';
...
const apiUrl = 'services/social/api/tags';
const apiSearchUrl = 'services/social/api/_search/tags';

// Actions

export const searchEntities = createAsyncThunk('tag/search_entity', async ({ query, page, size, sort }: IQueryParams) => {

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKEXCHANGE_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STOCKEXCHANGES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STOCKEXCHANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKEXCHANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKEXCHANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKEXCHANGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKEXCHANGE actions', async () => {
      const expectedActions = [
        {

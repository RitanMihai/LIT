...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INCOMEHISTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INCOMEHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INCOMEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INCOMEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INCOMEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INCOMEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INCOMEHISTORY actions', async () => {
      const expectedActions = [
        {

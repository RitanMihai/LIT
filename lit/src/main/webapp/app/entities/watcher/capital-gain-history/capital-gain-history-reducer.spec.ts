...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './capital-gain-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAPITALGAINHISTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_CAPITALGAINHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_CAPITALGAINHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAPITALGAINHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAPITALGAINHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAPITALGAINHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAPITALGAINHISTORY actions', async () => {
      const expectedActions = [
        {

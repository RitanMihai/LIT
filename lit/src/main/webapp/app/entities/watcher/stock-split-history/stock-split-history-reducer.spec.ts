...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './stock-split-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STOCKSPLITHISTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_STOCKSPLITHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_STOCKSPLITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STOCKSPLITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STOCKSPLITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STOCKSPLITHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STOCKSPLITHISTORY actions', async () => {
      const expectedActions = [
        {

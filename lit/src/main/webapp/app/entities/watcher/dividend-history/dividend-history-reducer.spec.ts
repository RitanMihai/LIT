...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIVIDENDHISTORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DIVIDENDHISTORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DIVIDENDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIVIDENDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIVIDENDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIVIDENDHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIVIDENDHISTORY actions', async () => {
      const expectedActions = [
        {

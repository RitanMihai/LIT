...
import { ICompany, defaultValue } from 'app/shared/model/watcher/company.model';
...
const apiUrl = 'services/watcher/api/companies';
const apiSearchUrl = 'services/watcher/api/_search/companies';

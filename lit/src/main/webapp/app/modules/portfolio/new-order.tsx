...
import { getEntity, reset, createEntity, updateEntity } from 'app/entities/portfolio/order/order.reducer';
import { Container } from '@mui/system';

export const NewOrder = (props: RouteComponentProps<{ id: string }>) => {
                ...
                <CardContent>
                    {loading ? (
                        ...
                        <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
                            ...
                            <Button tag={Link} id="cancel-save" data-cy="entityCreateCancelButton" to={`/portfolios/portfolio/${props.match.url.split("/")[3]}`} replace color="info">

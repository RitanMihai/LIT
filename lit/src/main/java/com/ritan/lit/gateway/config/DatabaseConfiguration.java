package com.ritan.lit.gateway.config;
...
@Configuration
@EnableR2dbcRepositories({ "com.ritan.lit.gateway.repository" })
@EnableTransactionManagement
@EnableReactiveElasticsearchRepositories("com.ritan.lit.gateway.repository.search")

...
import com.ritan.lit.social.service.TagService;
...
class TagResourceIT {
     ...
     *
     * @see com.ritan.lit.social.repository.search.TagSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().stockName(DEFAULT_STOCK_NAME).ticker(DEFAULT_TICKER);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().stockName(UPDATED_STOCK_NAME).ticker(UPDATED_TICKER);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getStockName()).isEqualTo(DEFAULT_STOCK_NAME);
        assertThat(testTag.getTicker()).isEqualTo(DEFAULT_TICKER);
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.stockName(UPDATED_STOCK_NAME).ticker(UPDATED_TICKER);
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getStockName()).isEqualTo(UPDATED_STOCK_NAME);
        assertThat(testTag.getTicker()).isEqualTo(UPDATED_TICKER);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.stockName(UPDATED_STOCK_NAME);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.stockName(UPDATED_STOCK_NAME).ticker(UPDATED_TICKER);
    ...
    void searchTag() throws Exception {
        ...
        // Initialize the database
        tagRepository.saveAndFlush(tag);
        when(mockTagSearchRepository.search("id:" + tag.getId())).thenReturn(Stream.of(tag));

...
class CommentResourceIT {
     ...
     *
     * @see com.ritan.lit.social.repository.search.CommentSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().content(DEFAULT_CONTENT).date(DEFAULT_DATE).language(DEFAULT_LANGUAGE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().content(UPDATED_CONTENT).date(UPDATED_DATE).language(UPDATED_LANGUAGE);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.content(UPDATED_CONTENT).date(UPDATED_DATE).language(UPDATED_LANGUAGE);
        ...
        assertThat(testComment.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).language(UPDATED_LANGUAGE);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.content(UPDATED_CONTENT).date(UPDATED_DATE).language(UPDATED_LANGUAGE);
    ...
    void searchComment() throws Exception {
        ...
        // Initialize the database
        commentRepository.saveAndFlush(comment);
        when(mockCommentSearchRepository.search("id:" + comment.getId(), PageRequest.of(0, 20)))

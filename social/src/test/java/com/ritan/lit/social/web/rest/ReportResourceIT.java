...
class ReportResourceIT {
    ...
    private static final RportType DEFAULT_TYPE = RportType.SPAM;
    private static final RportType UPDATED_TYPE = RportType.NUDITY;
    ...
    private static final String ENTITY_SEARCH_API_URL = "/api/_search/reports";
     ...
     *
     * @see com.ritan.lit.social.repository.search.ReportSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Report createEntity(EntityManager em) {
        Report report = new Report().type(DEFAULT_TYPE).description(DEFAULT_DESCRIPTION);
        return report;
    }
    ...
    public static Report createUpdatedEntity(EntityManager em) {
        Report report = new Report().type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
        return report;
    }
    ...
    void putNewReport() throws Exception {
        ...
        updatedReport.type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
        ...
        // Validate the Report in Elasticsearch
        verify(mockReportSearchRepository).save(testReport);
    }
    ...
    void partialUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateReportWithPatch() throws Exception {
        ...
        partialUpdatedReport.type(UPDATED_TYPE).description(UPDATED_DESCRIPTION);
    ...
    void searchReport() throws Exception {
        ...
        // Initialize the database
        reportRepository.saveAndFlush(report);
        when(mockReportSearchRepository.search("id:" + report.getId())).thenReturn(Stream.of(report));
